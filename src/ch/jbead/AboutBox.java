...
public class AboutBox extends JDialog {
    ...
    private void setEnglishText() {
        String t = "<html><h1>jbead</h1>" +
        		"<p>This is <b>jbead</b>, a program designed to help you design crochet bead ropes. " +
    ...
    private void setGermanText() {
        String t = "<html><h1>jbead</h1>" +
                "<p>Dies ist <b>jbead</b>, ein Programm, das Ihnen beim Entwurf von gehäkelten " +
